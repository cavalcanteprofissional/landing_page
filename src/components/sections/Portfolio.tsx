...
import { ExternalLink, Github, HelpCircle, ChartLine, Bot, Eye, Database, Brain, PieChart } from 'lucide-react';
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  const Icon = iconMap[project.icon] || HelpCircle;
  ...
  return (
    <section id="portfolio" className="py-24">
      <div className="section-container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('sections.portfolio')}</h2>
